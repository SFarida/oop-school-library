...
<div align="center">
  ...
  <h3><b>OOP School Library Ruby App</b></h3>
...
```sh
  git clone https://github.com/SFarida/oop-school-library.git
```
...
Feel free to check the [issues page](https://github.com/SFarida/oop-school-library/issues).
